...
<style>
body{ 
  background:url(images/farmer.jpeg) no-repeat;
    background-size: 100%;;
 } 
 .login_form{
 	margin-top: 25%;
...
//            $result = mysqli_query($conn,"INSERT into user(name,email,password,role) values('$name','$email','$password','former')");

            $result = "INSERT into user(name,email,password,role, image) values('$name','$email','$password','former', '$image')";
			 ...
			 if($result==1)
            {
                $sql2 = "INSERT INTO former(name, email, password, role, image)VALUES('$name','$email','$password','former','$image')";
...
?>
      ...
      <?php if(isset($done)) 
      { ?>
    <div class="successmsg"><span style="font-size: 60px;text-align: center;margin-left: 110px;">&#9989;</span> <br> <span style="font-size:20px; font-weight: 600;">You have registered successfully . </span><br> <br><a href="login.php" style="color:#fff; background: #000; padding: 10px;">Login here... </a> </div>
      <?php } else { ?>
       <div class="signup_form">
      <div class="center">
               <h1 class="farmer">Farmer Register</h1>
