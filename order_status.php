...
<div class="container_display">
	...
	<div class="dropdown">
<span style="float:right;">  <button class="btn-primary">Category</button></span>
...
<a href="index.php"><span style="float:left;">  <button class="btn-primary">Shopping</button></span></a> &nbsp;

<a href="vieworder.php"><span style="float:left;">  <button class="btn-primary">View Cart</button></span></a> &nbsp;
<a href="userorder.php"><span style="float:left;">  <button class="btn-primary">Order Page</button></span></a> &nbsp;
...
$res=mysqli_query($db,"SELECT * from tbl_order WHERE userid=$id");
